...
import {
    House, Article, AdminPanelSettings, SpaceDashboard, PeopleAlt, Campaign, Brightness7, Brightness4, Logout, Login, Grading
...
export default function Navbar() {
    ...
    const drawerLinks = [
        ...
        { label: 'Shopper', path: '/shopper-form', icon: <Grading />, roles: ['Admin', 'Shopper'] },
